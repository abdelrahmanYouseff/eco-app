    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">إضافة وحدة جديدة</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('property-management.units.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('unit_type') is-invalid @enderror" 
                                        ...
                                        <option value="مكتب" {{ old('unit_type') == 'مكتب' ? 'selected' : '' }}>مكتب</option>
                                        <option value="شقة" {{ old('unit_type') == 'شقة' ? 'selected' : '' }}>شقة</option>
                                        <option value="محل" {{ old('unit_type') == 'محل' ? 'selected' : '' }}>محل</option>
                                    </select>
                                    @error('unit_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select @error('finishing_type') is-invalid @enderror" 
                                            ...
                                            name="finishing_type">
                                        <option value="">اختر النوع</option>
                                        <option value="furnished" {{ old('finishing_type') == 'furnished' ? 'selected' : '' }}>مفروش</option>
                                        <option value="unfurnished" {{ old('finishing_type') == 'unfurnished' ? 'selected' : '' }}>غير مفروش</option>
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3 d-flex align-items-end">
                                    <p class="text-muted small mb-0">
                                        منفصل عن <strong>قراءة عداد الكهرباء</strong> أدناه.
                                    </p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('current_electricity_meter') }}"
                    ...
                    <div class="card border-0 shadow-sm">
                        <div class="card-body p-4">
                            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                                <a href="{{ request('building_id') ? route('property-management.buildings.show', request('building_id')) : route('property-management.units.index') }}" class="btn-action btn-cancel">
