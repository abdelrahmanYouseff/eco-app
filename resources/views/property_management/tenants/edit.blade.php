    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">تعديل بيانات المستأجر</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('property-management.tenants.update', $tenant->id) }}" method="POST" id="tenantForm">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('client_type') is-invalid @enderror" 
                                        ...
                                        <option value="فرد" {{ old('client_type', $tenant->client_type) == 'فرد' ? 'selected' : '' }}>فرد</option>
                                        <option value="شركة" {{ old('client_type', $tenant->client_type) == 'شركة' ? 'selected' : '' }}>شركة</option>
                                    </select>
                                    @error('client_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('id_number_or_cr', $tenant->id_number_or_cr) }}" 
                                           required
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="id_type" 
                                           name="id_type" 
                                           value="{{ old('id_type', $tenant->id_type) }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <textarea class="form-control @error('national_address') is-invalid @enderror" 
                                              ...
                                              rows="3"
                                              placeholder="العنوان الوطني الكامل">{{ old('national_address', $tenant->national_address) }}</textarea>
