    ...
    <div class="pc-content">
                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">تعديل العقد: {{ $contract->contract_number }}</h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form action="{{ route('property-management.contracts.update', $contract->id) }}" method="POST" id="contractForm">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select @error('contract_type') is-invalid @enderror" 
                                        ...
                                        <option value="جديد" {{ old('contract_type', $contract->contract_type) == 'جديد' ? 'selected' : '' }}>جديد</option>
                                        <option value="مجدد" {{ old('contract_type', $contract->contract_type) == 'مجدد' ? 'selected' : '' }}>مجدد</option>
                                    </select>
                                    @error('contract_type')
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select @error('building_id') is-invalid @enderror" 
                                        ...
                                        <option value="{{ $building->id }}" {{ old('building_id', $contract->building_id) == $building->id ? 'selected' : '' }}>
                                            {{ $building->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('broker_id') is-invalid @enderror" 
                                        ...
                                        <option value="{{ $broker->id }}" {{ old('broker_id', $contract->broker_id) == $broker->id ? 'selected' : '' }}>
                                            {{ $broker->name }}
                                        </option>
                                        @empty
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" 
                                           ...
                                           value="{{ old('contract_signing_date', $contract->contract_signing_date ? $contract->contract_signing_date->format('Y-m-d') : '') }}">
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" 
                                               ...
                                               name="is_conditional" 
                                               value="1"
                                               {{ old('is_conditional', $contract->is_conditional) ? 'checked' : '' }}>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               id="total_rent" 
                                               name="total_rent" 
                                               value="{{ old('total_rent', $contract->total_rent) }}" 
                                               required
                                               min="0"
                                               placeholder="0.00">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               id="annual_rent" 
                                               name="annual_rent" 
                                               value="{{ old('annual_rent', $contract->annual_rent) }}" 
                                               required
                                               min="0"
                                               placeholder="0.00">
                                        <span class="input-group-text">ريال</span>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="rent_cycle" 
                                           name="rent_cycle" 
                                           value="{{ old('rent_cycle', $contract->rent_cycle) }}" 
                                           required
                                           min="1"
                                           placeholder="12">
                                    @error('rent_cycle')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               id="vat_amount" 
                                               name="vat_amount" 
                                               value="{{ old('vat_amount', $contract->vat_amount) }}" 
                                               min="0"
                                               placeholder="0.00">
                                        <span class="input-group-text">ريال</span>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               value="{{ old('general_services_amount', $contract->general_services_amount) }}" 
                                               min="0"
                                               placeholder="0.00">
                                        <span class="input-group-text">ريال</span>
                                    </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="number" 
                                               ...
                                               id="fixed_amounts" 
                                               name="fixed_amounts" 
                                               value="{{ old('fixed_amounts', $contract->fixed_amounts ?? 0) }}" 
                                               min="0"
                                               placeholder="0.00">
                                        <span class="input-group-text">ريال</span>
                                    </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('insurance_policy_number', $contract->insurance_policy_number) }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const currentBuildingId = {{ $contract->building_id }};
    const currentUnitId = {{ $contract->unit_id }};
    
    // Load units for current building on page load
