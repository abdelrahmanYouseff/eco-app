                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h2 class="mb-0">إضافة وسيط جديد</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-8 mx-auto">
                <div class="card border-0 shadow-sm">
                    <div class="card-header" style="background-color: #f8f9fa; border-bottom: 1px solid #e9ecef;">
                        <h5 class="mb-0" style="font-weight: 600; color: #212529;">بيانات الوسيط</h5>
                    </div>
                    <div class="card-body">
                        @if(session('error'))
                        ...
                        <form action="{{ route('property-management.brokers.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="cr_number" name="cr_number" value="{{ old('cr_number') }}">
                            </div>
                            ...
                            <div class="d-flex justify-content-end gap-2">
                                <a href="{{ route('property-management.brokers.index') }}" class="btn btn-outline-secondary">إلغاء</a>
